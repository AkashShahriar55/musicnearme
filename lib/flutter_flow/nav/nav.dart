...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : CatchPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: OldHomePageWidget.routeName,
          path: OldHomePageWidget.routePath,
        ...
        FFRoute(
          name: EditProfileInfoWidget.routeName,
          path: EditProfileInfoWidget.routePath,
        ...
        FFRoute(
          name: CatchPageWidget.routeName,
          path: CatchPageWidget.routePath,
          builder: (context, params) => CatchPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: StartRoutePageWidget.routeName,
          path: StartRoutePageWidget.routePath,
          builder: (context, params) => StartRoutePageWidget(
            placeData: params.getParam(
              'placeData',
              ParamType.DataStruct,
              isList: false,
              structBuilder: PlaceDataStruct.fromSerializableMap,
            ),
          ),
        ),
        FFRoute(
          name: NewHomePageWidget.routeName,
          path: NewHomePageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'newHomePage')
              : NewHomePageWidget(),
        ),
        FFRoute(
          name: ViewPlacePageWidget.routeName,
          path: ViewPlacePageWidget.routePath,
          asyncParams: {
            'placeDoc': getDoc(['places'], PlacesRecord.fromSnapshot),
          },
          builder: (context, params) => ViewPlacePageWidget(
        ...
        FFRoute(
          name: ViewCreatedPlacesWidget.routeName,
          path: ViewCreatedPlacesWidget.routePath,
          builder: (context, params) => ViewCreatedPlacesWidget(),
        ),
        FFRoute(
          name: SubmitLocationWidget.routeName,
          path: SubmitLocationWidget.routePath,
          builder: (context, params) => SubmitLocationWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AdminViewPlaceWidget.routeName,
          path: AdminViewPlaceWidget.routePath,
          builder: (context, params) => AdminViewPlaceWidget(
            placeRef: params.getParam(
              'placeRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: SearchPageCopyWidget.routeName,
          path: SearchPageCopyWidget.routePath,
