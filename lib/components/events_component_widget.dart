...
class EventsComponentWidget extends StatefulWidget {
  const EventsComponentWidget({
    super.key,
    this.placeRef,
    this.img,
    this.name,
  ...
  @override
  State<EventsComponentWidget> createState() => _EventsComponentWidgetState();
}

class _EventsComponentWidgetState extends State<EventsComponentWidget> {
  late EventsComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventsComponentModel());
            ...
            child: Container(
              ...
              child: PageView(
                ...
                children: [
                  Stack(
                    children: [
                      if (_model.newEvents != null &&
                          (_model.newEvents)!.isNotEmpty)
                        Container(
                          decoration: BoxDecoration(),
                          child: Builder(
                            builder: (context) {
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (confirmDialogResponse) {
                                                                          ...
                                                                          _model.newEventsAfterDeleteListView =
                                                                              await actions.createEventListAction(
                                                                            _model.eventsQueryAfterDeleteListview!.toList(),
                                                                          );
                                                                          _shouldSetState =
                                                                              true;
                      ...
                      if (!(_model.newEvents != null &&
                        ...
                        Align(
                          alignment: AlignmentDirectional(0.0, 0.0),
                          child: wrapWithModel(
                            model: _model.noEventsComponentModel,
