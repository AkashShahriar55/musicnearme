...
class StaticDirectionsMap extends StatefulWidget {
  const StaticDirectionsMap({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<StaticDirectionsMap> createState() => _StaticDirectionsMapState();
}

class _StaticDirectionsMapState extends State<StaticDirectionsMap>
