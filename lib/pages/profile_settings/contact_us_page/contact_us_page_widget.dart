...
class _ContactUsPageWidgetState extends State<ContactUsPageWidget> {
  ...
  void initState() {
    ...
    _model.contactAreaTextController ??= TextEditingController();
    _model.contactAreaFocusNode ??= FocusNode();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              controller: _model.contactAreaTextController,
                              focusNode: _model.contactAreaFocusNode,
                              autofocus: true,
                              ...
                              validator: _model
                                  .contactAreaTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                await launchUrl(Uri(
                                    scheme: 'mailto',
                                    path: 'locations@musicnearme.com',
                                    query: {
                                      'subject':
                                          'Contact Us Submission - ${currentUserDisplayName}',
                                      'body':
                                          _model.contactAreaTextController.text,
                                    }
                                        .entries
