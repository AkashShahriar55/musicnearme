...
class PlaceListItemWidget extends StatefulWidget {
  const PlaceListItemWidget({
    super.key,
    required this.placeDoc,
    this.favoritesCallback,
  });

  final PlacesRecord? placeDoc;
  final Future Function()? favoritesCallback;

  @override
  State<PlaceListItemWidget> createState() => _PlaceListItemWidgetState();
}

class _PlaceListItemWidgetState extends State<PlaceListItemWidget> {
  late PlaceListItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlaceListItemModel());
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            if ((currentUserDocument?.favorites?.toList() ?? [])
                              ...
                              await widget.favoritesCallback?.call();
                            } else {
                              await currentUserReference!.update({
                                ...mapToFirestore(
                                  {
